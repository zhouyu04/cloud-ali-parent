package com.zzyy.outh_server.service.impl;
...
public class LoginServiceImpl implements LoginService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret, String grandType) {
        ...
        ServiceInstance choose = loadBalancerClient.choose("outh-server");
        ...
        log.info("请求URL：" + url + ",requestentity:" + JSON.toJSONString(requestentity));
        ResponseEntity<Map> responseEntity = restTemplate.exchange(url, HttpMethod.POST, requestentity, Map.class);
        log.info("返回:" + JSON.toJSONString(responseEntity));
        //5.接收到返回的响应(就是:令牌的信息)
